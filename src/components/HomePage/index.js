...
import { PiLessThanBold, PiLineVertical } from "react-icons/pi";
    ...
    return (
        <div className='homepage-container'>
            ...
            <div className='types'>
                ...
                {typeSelected == 7 ? <p className='selected'>Gujarati</p> : <p onClick={() => setTypeSelected(7)}>Gujarati</p>}

                {typeSelected == 8 ? <p className='selected'>Spanish</p> : <p onClick={() => setTypeSelected(8)}>Spanish</p>}
